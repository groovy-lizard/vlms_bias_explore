...
img_path = "./fface_full_img_embs.pkl"
fface_path = "./data/fairface/fface_full.csv"
...
race_classes = ["white", "non-white"]
preds_classes = ['White', 'Non-White']
...
new_df.to_csv(f"{model_name}_{data_source}_binary_race_clip_aggregation.csv")
